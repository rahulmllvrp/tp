...
public class AddEventCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        String userInput = " n/John's Birthday d/12-12-2024 t/18:00 b/500";
        Event expectedEvent = new Event(
                new EventName("John's Birthday"),
                new EventDate("12-12-2024"),
                new EventTime("18:00"),
                new Budget("500"));
    ...
    public void parse_validLeapYearDate_success() {
        String userInput = " n/Leap Day Party d/29-02-2024 t/18:00 b/500";
        Event expectedEvent = new Event(
    ...
    public void parse_invalidDate_failure() {
        ...
        String userInput = " n/Invalid Party d/31-04-2024 t/18:00 b/500";
        assertParseFailure(parser, userInput, EventDate.MESSAGE_CONSTRAINTS);
    }
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing name prefix
        assertParseFailure(parser, " d/12-12-2024 t/18:00 b/500", expectedMessage);

        // missing date prefix
        assertParseFailure(parser, " n/John's Birthday t/18:00 b/500", expectedMessage);

        // missing time prefix
        assertParseFailure(parser, " n/John's Birthday d/12-12-2024 b/500", expectedMessage);

        // missing budget prefix
        assertParseFailure(parser, " n/John's Birthday d/12-12-2024 t/18:00", expectedMessage);
    }
}
